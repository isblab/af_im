...
# Dir to store all relevant modeling output.
BASE_DIR = "./benchmark/"
...
def get_sys_config_path(
	...
	benchmark_name -> name of the benchmark.
	sys_name -> name of the complex modeled. For the benchmark, it's the PDB ID.
	sys_conf_suff -> suffix for the system config file.
...
def get_benchmark_csv_file(
	...
	csv_file_path = os.path.join(
		meta_dir, f"selected_{benchmark_name}_benchmark.csv"
	)
...
def get_init_pred_file(
	...
	init_pred_file = os.path.join(
		data_dir,
		f"{sys_name}_output/predictions/output_dict.pkl" )
